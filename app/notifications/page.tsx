...
const T = {
  ko: { title: '알림', comingSoon: '준비 중입니다', backHome: '홈으로 돌아가기' },
  en: { title: 'Notifications', comingSoon: 'Coming Soon', backHome: 'Back to Home' },
  zh: { title: '通知', comingSoon: '准备中', backHome: '返回首页' },
  ja: { title: '通知', comingSoon: '準備中', backHome: 'ホームに戻る' },
} as const;
