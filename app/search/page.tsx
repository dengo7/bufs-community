...
const T = {
  ko: { title: '검색', comingSoon: '준비 중입니다', backHome: '홈으로 돌아가기' },
  en: { title: 'Search', comingSoon: 'Coming Soon', backHome: 'Back to Home' },
  zh: { title: '搜索', comingSoon: '准备中', backHome: '返回首页' },
  ja: { title: '検索', comingSoon: '準備中', backHome: 'ホームに戻る' },
} as const;
