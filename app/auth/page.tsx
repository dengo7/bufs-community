        ...
        <div className="px-6 sm:px-8 pt-8 pb-6">
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              disabled={loading}
              className="w-full py-3 text-base font-medium rounded-xl border border-gray-200 bg-white text-gray-700 flex items-center justify-center gap-2.5 active:scale-[0.98] transition-all hover:bg-gray-50 disabled:opacity-60"
            >
              <GoogleIcon />
              {t.google}
            </button>
            <button
              ...
              disabled={loading}
              className="w-full py-3 text-base font-medium rounded-xl bg-[#FEE500] text-[#3C1E1E] flex items-center justify-center gap-2.5 active:scale-[0.98] transition-all hover:brightness-95 disabled:opacity-60"
            >
              <KakaoIcon />
              {t.kakao}
            </button>
...
function KakaoIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" fill="#3C1E1E">
      <path d="M12 3C6.48 3 2 6.47 2 10.73c0 2.75 1.77 5.16 4.43 6.56-.18.64-.65 2.35-.74 2.71-.12.46.17.46.36.33.15-.1 1.98-1.35 2.78-1.9.69.1 1.41.15 2.17.15 5.52 0 10-3.47 10-7.73S17.52 3 12 3z" />
    </svg>
  );
}
