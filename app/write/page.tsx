...
const T = {
  ko: { title: '글쓰기', comingSoon: '준비 중입니다', backHome: '홈으로 돌아가기' },
  en: { title: 'Write', comingSoon: 'Coming Soon', backHome: 'Back to Home' },
  zh: { title: '写作', comingSoon: '准备中', backHome: '返回首页' },
  ja: { title: '投稿', comingSoon: '準備中', backHome: 'ホームに戻る' },
} as const;
